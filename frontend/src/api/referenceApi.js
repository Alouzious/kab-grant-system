...
/**
 * Get all faculties
 * @returns {Promise<Array>} Array of faculty objects formatted for dropdowns
 */
 ...
 * @returns {Promise<Array>} Array of department objects formatted for dropdowns
 */
...
export async function getResearchDisciplines() {
  try {
    // Backend doesn't have a dedicated endpoint for this yet,
...
/**
 * Get system settings (submission deadline, active academic year, etc.)
